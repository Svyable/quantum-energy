...
def validate_json() -> dict:
    ...
    # Do not silently advertise a license in machine metadata while the repo has
    # no selected root LICENSE file. The project can intentionally change this
    # rule when licenses are actually selected.
